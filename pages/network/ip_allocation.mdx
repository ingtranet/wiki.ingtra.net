...
export const mdc = [
  ...
  {cidr: '10.3.2.0/24',     vlan: '302',   gateway: 'USW-Enterprise-8',   description: 'Small Board Devices'},
  {cidr: '10.3.3.0/24',     vlan: '303',   gateway: 'USW-Enterprise-8',   description: 'Network Attached Storages'},
